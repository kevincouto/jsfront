...
(function(){
    var DateReplaceChars = {
        ...
        D : function(dt) {return DateReplaceChars.shortDays[dt.getDay()];},
        j : function(dt) {return dt.getDate();},
        l : function(dt) {return DateReplaceChars.longDays[dt.getDay()];},
        ...
        // Month
        F : function(dt) {return DateReplaceChars.longMonths[dt.getMonth()];},
        m : function(dt) {return (dt.getMonth() < 9 ? '0' : '') + (dt.getMonth() + 1);},
        M : function(dt) {return DateReplaceChars.shortMonths[dt.getMonth()];},
