...
(function(){
    ...
    function createInput(jtext, type){
        if (jtext._input){
            jsf.Keyboard.removeInputMask(jtext._input);
            jsf.Dom.remove(jtext._input);
        }
        
        jtext._canvas.innerHTML = '<input type="'+type+'" />';
        jtext._canvas.className = 'txt ui-bd txt-border';
        
        jtext._input = jtext._canvas.childNodes[0];
    }
